...
class Php54Http < AbstractPhp54Extension
  ...
  def install
    ...
    cp "#{Formula.factory('php54-raphf').opt_prefix}/include/php_raphf.h", "ext/raphf/php_raphf.h"

    # link in the propro extension header
    system "mkdir -p ext/propro"
    cp "#{Formula.factory('php54-propro').opt_prefix}/include/php_propro.h", "ext/propro/php_propro.h"
