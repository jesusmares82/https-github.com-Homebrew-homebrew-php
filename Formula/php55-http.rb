...
class Php55Http < AbstractPhp55Extension
  ...
  url 'http://pecl.php.net/get/pecl_http-2.0.3.tgz'
  sha1 '853612bea11ba201e2ccf1c0e0ad64e26e0928bc'
  ...
  def install
    ...
    cp "#{Formula.factory('php55-raphf').opt_prefix}/include/php_raphf.h", "ext/raphf/php_raphf.h"

    # link in the propro extension header
    system "mkdir -p ext/propro"
    cp "#{Formula.factory('php55-propro').opt_prefix}/include/php_propro.h", "ext/propro/php_propro.h"
