...
class Phpmyadmin < Formula
  ...
  url 'http://downloads.sourceforge.net/project/phpmyadmin/phpMyAdmin/4.1.4/phpMyAdmin-4.1.4-all-languages.tar.gz'
  sha1 '9cdbe46949b6d09f44c8f16ab1bd5e79624b7c2a'
