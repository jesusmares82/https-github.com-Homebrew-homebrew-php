...
class Phpmyadmin < Formula
  ...
  url 'http://downloads.sourceforge.net/project/phpmyadmin/phpMyAdmin/4.0.9/phpMyAdmin-4.0.9-all-languages.tar.gz'
  sha1 '18d027971e6d334b0941b45452e49dc361c322bd'
